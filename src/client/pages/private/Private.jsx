...
import { RegistrarDashboard } from "./Registrar/RegistrarDashboard.jsx";
  ...
  return (
    <RoutesWithNotFound>
      ...
      <Route path={PrivateRoutes.DASHBOARD} element={<Dashboard />} >
        <Route path={PrivateRoutes.REGISTRAR} element={<RegistrarDashboard />} />
        <Route path={PrivateRoutes.ADMIN} >
